...
#endif
		#define DEFAULT_X_MAX_RATE 800.0f 						// X axis mm/min // 600
		#define DEFAULT_Y_MAX_RATE 800.0f 						// Y axis mm/min
		#define DEFAULT_Z_MAX_RATE 800.0f 						// Z axis mm/min
#if defined(AA_AXIS) || defined(AB_AXIS) || defined(ABC_AXIS)
		#define DEFAULT_A_MAX_RATE 800.0f 						// A axis mm/min
#endif
#if defined(AB_AXIS) || defined(ABC_AXIS)
		#define DEFAULT_B_MAX_RATE 800.0f 						// B axis mm/min
#endif
#if defined(ABC_AXIS)
