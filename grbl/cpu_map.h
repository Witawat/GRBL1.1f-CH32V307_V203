...
#define RCC_COOLANT_FLOOD_PORT        RCC_APB2Periph_GPIOE
#define COOLANT_FLOOD_BIT             13
#define COOLANT_MIST_PORT             GPIOE
#define RCC_COOLANT_MIST_PORT         RCC_APB2Periph_GPIOE
...
#define RCC_PROBE_PORT                RCC_APB2Periph_GPIOE
#define PROBE_BIT                     3
#define PROBE_MASK                    (1<<PROBE_BIT)
...
#define SPINDLE_PWM_RANGE         (SPINDLE_PWM_MAX_VALUE-SPINDLE_PWM_MIN_VALUE)
  ...
  //	Port E                    	Port A				Port D                             
  //	0  X_DIRECTION_BIT 								SPINDLE_DIRECTION_BIT
  //	1  X_STEP_BIT									SPINDLE_ENABLE_BIT
  //	2  Y_DIRECTION_BIT								DVP use
  //	3  Y_STEP_BIT									unconnected
  //	4  Z_DIRECTION_BIT								unconnected
  //	5  Z_STEP_BIT								    CONTROL_RESET_BIT
  //	6  A_DIRECTION_BIT								DVP use
  //	7  A_STEP_BIT								    CONTROL_CYCLE_START_BIT
  //	8  B_DIRECTION_BIT		 SPINDLE_PWM_BIT	    CONTROL_SAFETY_DOOR_BIT
  //	9  B_STEP_BIT				                    CONTROL_FEED_HOLD_BIT
  //	10 C_DIRECTION_BIT		                        C_LIMIT_BIT
  //	11 C_STEP_BIT							        B_LIMIT_BIT
  //	12 COOLANT_MIST_BIT								X_LIMIT_BIT
  //	13 COOLANT_FLOOD_BIT			                Y_LIMIT_BIT
