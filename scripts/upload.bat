...
:: ============================================================
::  Select MCU Config — SAME AS build.bat
:: ============================================================
call "%~dp0mcu_config_CH32V307.bat"
::call "%~dp0mcu_config_CH32V203.bat"

:: ============================================================
::  upload.bat - Flash via WCH-Link using OpenOCD
:: ============================================================
...
set ELF_FILE=%WORKSPACE%output\%OUTPUT_NAME%.elf

echo ============================================================
echo  GRBL %MCU_NAME% Upload via WCH-Link
echo ============================================================
